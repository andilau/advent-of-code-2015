...
class SolutionsTest {
    ...
    fun testAdventOfCode() = listOf(
        ...
        Day19(InputReader.getInputAsList(19)) to Pair(535, 212),
        ...
        Day24(InputReader.getInputAsListOfInt(24)) to Pair(10_723_906_903, 74_850_409L),
        Day25(InputReader.getInputAsString(25)) to Pair(19_980_801L, Unit),
    )
        .map { (day, answers) ->
